...
def read_mixed_docs():
    ...
    for i in range(10000):
        key = 'jdoc_60k_{:}{:}'.format(random.randint(0, MAX_DOCS_INDEX), long_suffix)
        ...
        for j in range(10):
            key = 'jdoc_80k_{:}{:}'.format(random.randint(0, MAX_DOCS_INDEX), long_suffix)
        ...
        for j in range(2):
            key = 'jdoc_100k_{:}{:}'.format(random.randint(0, MAX_DOCS_INDEX), long_suffix)
